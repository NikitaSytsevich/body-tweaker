...
Telegram Mini App для практики голодания, дыхательных упражнений и биоритмов с наглядной «картой метаболизма», базой знаний и журналом прогресса. Приложение работает в Telegram и в браузере (с безопасными фолбэками), хранит данные в Telegram Cloud Storage и локально, шифрует их на клиенте.
...
- **Биоритмы**
  Калькулятор биоритмов по дате рождения, график динамики и показатели на сегодня.
