...
- **Карта метаболизма**
  Карта из 9 фаз с текущим статусом, прогрессом по активной фазе и подробными карточками (физиология, ощущения, рекомендации, меры предосторожности). Во время голодания карта открывается по умолчанию.

  Этапы: `0–4ч`, `4–12ч`, `12–18ч`, `18–24ч`, `24–36ч`, `36–48ч`, `48–72ч`, `72–120ч`, `120–168ч`.
