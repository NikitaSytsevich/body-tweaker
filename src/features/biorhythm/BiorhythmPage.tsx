    ...
    <div className="pb-8 animate-in fade-in duration-500">
      <div className="bg-white dark:bg-[#2C2C2E] p-4 rounded-2xl shadow-sm border border-slate-100 dark:border-white/10 flex items-center justify-between mb-4 mx-4 mt-2">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-xs text-slate-400 dark:text-slate-500 font-bold uppercase">Дата рождения</p>
            <input
              type="date"
              value={birthDate}
      ...
      <div className="px-4">
        <h2 className="text-lg font-bold text-slate-800 dark:text-white ml-1">Энергетические волны</h2>
