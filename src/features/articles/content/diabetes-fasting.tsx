    ...
    <div className="space-y-8 text-slate-800 text-lg leading-relaxed pb-10">
      ...
      <section>
        <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-2xl font-[900] text-slate-900">Диабет 1 типа</h3>
        </div>
        <p className="mb-4">
        ...
        <div className="bg-red-50 p-6 rounded-3xl border border-red-100">
            <h4 className="font-bold text-red-900 mb-3">Почему это опасно?</h4>
        ...
        <div className="mt-6 bg-blue-50 p-6 rounded-3xl border border-blue-100">
            <h4 className="font-bold text-blue-900 mb-2">Альтернатива для диабета 1 типа</h4>
      ...
      <section>
        <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-2xl font-[900] text-slate-900">Диабет 2 типа</h3>
        </div>
        <p className="mb-4">
        ...
        <div className="bg-emerald-50 p-6 rounded-3xl border border-emerald-100 space-y-4">
            <h4 className="font-bold text-emerald-900 mb-2">Польза голодания при диабете 2 типа:</h4>
        ...
        <div className="mt-6 bg-slate-50 p-6 rounded-3xl">
            <h4 className="font-bold text-slate-900 mb-2">Научные данные</h4>
      ...
      <section>
        <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-2xl font-[900] text-slate-900">Научные исследования</h3>
        </div>

        <div className="space-y-4">
            <div className="bg-blue-50 p-5 rounded-2xl border border-blue-100">
                <h4 className="font-bold text-blue-900 mb-2">Ремиссия диабета 2 типа</h4>
                <p className="text-sm text-blue-800 mb-3">
                ...
                <a href="https://www.bmj.com/content/368/bmj.m694" target="_blank" rel="noopener noreferrer" className="text-xs text-blue-600 underline hover:text-blue-800">
                    McCombie L. et al., Remission of type 2 diabetes, 2020
                </a>
            </div>

            <div className="bg-blue-50 p-5 rounded-2xl border border-blue-100">
                <h4 className="font-bold text-blue-900 mb-2">Периодическое голодание и инсулин</h4>
                <p className="text-sm text-blue-800 mb-3">
                ...
                <a href="https://pubmed.ncbi.nlm.nih.gov/28887544/" target="_blank" rel="noopener noreferrer" className="text-xs text-blue-600 underline hover:text-blue-800">
                    Cheng C. et al., Fasting-Mimicking Diet, 2017
                </a>
            </div>

            <div className="bg-blue-50 p-5 rounded-2xl border border-blue-100">
                <h4 className="font-bold text-blue-900 mb-2">Снижение лекарств при голодании</h4>
                <p className="text-sm text-blue-800 mb-3">
                ...
                <a href="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6353026/" target="_blank" rel="noopener noreferrer" className="text-xs text-blue-600 underline hover:text-blue-800">
                    Fung J. et al., Therapeutic Fasting, 2018
                </a>
            </div>

            <div className="bg-blue-50 p-5 rounded-2xl border border-blue-100">
                <h4 className="font-bold text-blue-900 mb-2">Голодаание и метформин</h4>
                <p className="text-sm text-blue-800 mb-3">
                ...
                <a href="https://pubmed.ncbi.nlm.nih.gov/30476413/" target="_blank" rel="noopener noreferrer" className="text-xs text-blue-600 underline hover:text-blue-800">
      ...
      <section>
        <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-2xl font-[900] text-slate-900">Правила безопасности для диабета 2 типа</h3>
        </div>

        <div className="space-y-4">
            <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm">
                <h4 className="font-bold text-slate-800 mb-2 flex items-center gap-2">
                    <span className="w-6 h-6 bg-violet-100 text-violet-600 rounded-full flex items-center justify-center text-sm font-bold">1</span>
            ...
            <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm">
                <h4 className="font-bold text-slate-800 mb-2 flex items-center gap-2">
                    <span className="w-6 h-6 bg-violet-100 text-violet-600 rounded-full flex items-center justify-center text-sm font-bold">2</span>
                    Контролируйте сахар
                </h4>
                <p className="text-sm text-slate-700">
            ...
            <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm">
                <h4 className="font-bold text-slate-800 mb-2 flex items-center gap-2">
                    <span className="w-6 h-6 bg-violet-100 text-violet-600 rounded-full flex items-center justify-center text-sm font-bold">4</span>
                    Следите за кетонами
                </h4>
                <p className="text-sm text-slate-700">
            ...
            <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm">
                <h4 className="font-bold text-slate-800 mb-2 flex items-center gap-2">
                    <span className="w-6 h-6 bg-violet-100 text-violet-600 rounded-full flex items-center justify-center text-sm font-bold">5</span>
            ...
            <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm">
                <h4 className="font-bold text-slate-800 mb-2 flex items-center gap-2">
                    <span className="w-6 h-6 bg-violet-100 text-violet-600 rounded-full flex items-center justify-center text-sm font-bold">6</span>
      ...
      <section>
        <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-2xl font-[900] text-slate-900">Какой врач должен быть в курсе?</h3>
        </div>
