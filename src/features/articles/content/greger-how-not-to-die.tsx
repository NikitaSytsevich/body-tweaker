...
export const gregerHowNotToDie: Article = {
  ...
  imageUrl: '/images/articles/5.PNG',
  content: (
    <div className="space-y-8 text-slate-800 text-lg leading-relaxed pb-10">
      ...
      <section>
        <div className="flex items-center gap-3 mb-4">
          ...
          <h3 className="text-2xl font-[900] text-slate-900">15 причин смерти</h3>
        </div>
          ...
          {[
            ...
            <div key={i} className="bg-white p-5 rounded-2xl border border-slate-100 shadow-sm">
              <div className="flex items-center justify-between">
                <h5 className="font-bold text-slate-800">{item.disease}</h5>
                <span className="text-sm text-green-600">{item.food}</span>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="bg-red-50 p-6 rounded-3xl border border-red-100">
          <h4 className="font-bold text-red-900 mb-3">Паттерн продуктов</h4>
      ...
      <section>
        <div className="flex items-center gap-3 mb-4">
          ...
          <h3 className="text-2xl font-[900] text-slate-900">Ежедневная дюжина (Daily Dozen)</h3>
        </div>
      ...
      <section>
        <div className="flex items-center gap-3 mb-4">
          ...
          <h3 className="text-2xl font-[900] text-slate-900">Ключевые продукты-суперфуды</h3>
        </div>
        ...
        <div className="space-y-4">
          {[
            ...
            <div key={i} className="bg-white p-5 rounded-2xl border border-slate-100 shadow-sm">
              ...
              <p className="text-base text-slate-700 mb-2">{item.benefit}</p>
      ...
      <section>
        <div className="flex items-center gap-3 mb-4">
          ...
          <h3 className="text-2xl font-[900] text-slate-900">Продукты для ограничения</h3>
        </div>
        ...
        <div className="bg-red-50 p-6 rounded-3xl border border-red-100 mb-6">
          <h4 className="font-bold text-red-900 mb-3">На что обратить внимание</h4>
      ...
      <section>
        <div className="flex items-center gap-3 mb-4">
          ...
          <h3 className="text-2xl font-[900] text-slate-900">Научный подход</h3>
        </div>
