    ...
    <div className="space-y-8 text-slate-800 dark:text-slate-200 text-lg leading-relaxed pb-10">
      ...
      <section>
        ...
        <div className="bg-red-50 dark:bg-red-900/20 p-6 rounded-3xl border border-red-100 dark:border-red-900/30">
          <h4 className="font-bold text-red-900 dark:text-red-100 mb-3">Паттерн продуктов</h4>
      ...
      <section>
        ...
        <div className="bg-red-50 dark:bg-red-900/20 p-6 rounded-3xl border border-red-100 mb-6">
          <h4 className="font-bold text-red-900 dark:text-red-100 mb-3">На что обратить внимание</h4>
