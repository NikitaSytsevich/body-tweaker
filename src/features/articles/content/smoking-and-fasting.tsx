  ...
  content: (
    <div className="space-y-8 text-slate-800 text-lg leading-relaxed pb-10">
      ...
      <div className="bg-red-50 p-6 rounded-3xl border border-red-100 flex gap-4">
        ...
        <div>
            <h4 className="font-bold text-red-800 mb-1 text-lg">Краткий ответ</h4>
      ...
      <section>
        <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-2xl font-[900] text-slate-900">Обычные сигареты</h3>
        </div>
        <p className="mb-4">
        ...
        <div className="grid grid-cols-1 gap-4">
            ...
            <div className="bg-slate-50 p-5 rounded-2xl">
                <h4 className="font-bold text-slate-800 mb-2">4000+ химических веществ</h4>
                <p className="text-sm text-slate-700">
            ...
            <div className="bg-slate-50 p-5 rounded-2xl">
                <h4 className="font-bold text-slate-800 mb-2">Замедление аутофагии</h4>
                <p className="text-sm text-slate-700">
      ...
      <section>
        <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-2xl font-[900] text-slate-900">Вейпы и электронные сигареты</h3>
        </div>
        <p className="mb-4">
            Многие ошибочно считают вейпы «безопасной» альтернативой. Это миф, особенно в условиях голодания.
        </p>

        <div className="bg-violet-50 p-6 rounded-3xl border border-violet-100 space-y-4">
            <h4 className="font-bold text-violet-900">Что содержит жидкость для вейпа:</h4>
        ...
        <div className="mt-6 bg-orange-50 p-6 rounded-3xl border border-orange-100">
            <h4 className="font-bold text-orange-900 mb-2">Особая опасность при голодании</h4>
      ...
      <section>
        <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-2xl font-[900] text-slate-900">Что говорит наука</h3>
        </div>

        <div className="space-y-4">
            <div className="bg-blue-50 p-5 rounded-2xl border border-blue-100">
                <h4 className="font-bold text-blue-900 mb-2">Исследование влияния курения на аутофагию</h4>
                ...
                <a href="https://pubmed.ncbi.nlm.nih.gov/32426392/" target="_blank" rel="noopener noreferrer" className="text-xs text-blue-600 underline hover:text-blue-800">
                    Ghosh A. et al., Tobacco Smoking and Autophagy, 2020
                </a>
            </div>

            <div className="bg-blue-50 p-5 rounded-2xl border border-blue-100">
                <h4 className="font-bold text-blue-900 mb-2">Вред вейпов для легких</h4>
                <p className="text-sm text-blue-800 mb-3">
                ...
                <a href="https://pubmed.ncbi.nlm.nih.gov/30592963/" target="_blank" rel="noopener noreferrer" className="text-xs text-blue-600 underline hover:text-blue-800">
                    Wu Q. et al., Electronic Cigarette Aerosol Induces Lung Inflammation, 2018
                </a>
            </div>

            <div className="bg-blue-50 p-5 rounded-2xl border border-blue-100">
                <h4 className="font-bold text-blue-900 mb-2">Токсичные вещества в парах вейпа</h4>
                <p className="text-sm text-blue-800 mb-3">
                ...
                <a href="https://pubmed.ncbi.nlm.nih.gov/35577246/" target="_blank" rel="noopener noreferrer" className="text-xs text-blue-600 underline hover:text-blue-800">
      ...
      <section className="bg-emerald-50 p-6 rounded-3xl border border-emerald-100">
        <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-xl font-bold text-emerald-900">Голодание — лучший момент бросить курить</h3>
        </div>
        <div className="space-y-4">
      ...
      {/* Синдром отмены */}
      <section>
        <h3 className="text-2xl font-[900] text-slate-900 mb-4">Что если бросить не получается?</h3>
        <p className="mb-4">
        ...
        <div className="bg-blue-50 p-6 rounded-3xl border border-blue-100 space-y-4">
            <div className="flex items-start gap-3">
                ...
                <div>
                    <h4 className="font-bold text-blue-900 mb-1">Снижение эффективности</h4>
            ...
            <div className="flex items-start gap-3">
                <Info className="w-5 h-5 text-blue-600 shrink-0 mt-0.5" />
                <div>
                    <h4 className="font-bold text-blue-900 mb-1">Усиление абстинентного синдрома</h4>
                    <p className="text-sm text-blue-800">
            ...
            <div className="flex items-start gap-3">
                <Info className="w-5 h-5 text-blue-600 shrink-0 mt-0.5" />
                <div>
                    <h4 className="font-bold text-blue-900 mb-1">Компромиссный вариант</h4>
                    <p className="text-sm text-blue-800">
            ...
            <div className="flex items-start gap-3">
                <Info className="w-5 h-5 text-blue-600 shrink-0 mt-0.5" />
                <div>
                    <h4 className="font-bold text-blue-900 mb-1">Временный отказ</h4>
                    <p className="text-sm text-blue-800">
