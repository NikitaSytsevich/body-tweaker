// src/app/modals/ProfileModal.tsx
    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            {/* HEADER */}
            <div className="px-6 pt-6 pb-2 shrink-0 bg-[#F2F2F7] dark:bg-[#1C1C1E] z-20">
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-3xl font-[900] text-slate-800 dark:text-white">Профиль</h2>
                <button
                  onClick={onClose}
            ...
            {/* TABS */}
            <div className="px-6 py-2 shrink-0 bg-[#F2F2F7] dark:bg-[#1C1C1E]">
              <div className="bg-slate-200/50 dark:bg-white/10 p-1 rounded-2xl flex gap-1">
                {tabs.map((tab) => (
                  <button
                    key={tab.id}
                    ...
                    className={cn(
                      ...
                      activeTab === tab.id
                        ? "bg-white dark:bg-[#2C2C2E] shadow-sm text-slate-900 dark:text-white font-bold"
            ...
            <div className="flex-1 overflow-y-auto pb-safe px-4 pt-2">
              {activeTab === 'settings' ? (
                ...
                <div className="space-y-6 pb-safe">
                  ...
                  {/* Footer */}
                  <div className="pt-4 flex flex-col items-center gap-4 border-t border-slate-100 dark:border-white/5 pb-8">
